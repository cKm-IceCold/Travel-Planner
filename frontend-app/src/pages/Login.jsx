    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
            <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
                <h2 className="text-3xl font-serif font-bold text-center text-slate-800 mb-2">Welcome Back</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-600 text-white font-bold py-3 rounded-xl hover:bg-blue-700 transition-all shadow-lg text-lg disabled:opacity-50"
                    >
                        {loading ? "Logging In..." : "Log In"}
                    </button>
                </form>

                <div className="relative my-8 text-center text-sm font-medium text-slate-400">
